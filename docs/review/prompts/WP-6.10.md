# Agent prompt — WP-6.10: `NfcCodeTouch` and `LightsceneRGB` (PS-27) — two control types confirmed

You are implementing work package **WP-6.10** of the PyLoxone remediation plan.
...
### WP-6.10 `NfcCodeTouch` and `LightsceneRGB` (PS-27) — two control types confirmed
- **Scope**: `NfcCodeTouch` and `LightsceneRGB` (PS-27) — two control types confirmed
