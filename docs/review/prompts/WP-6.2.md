# Agent prompt — WP-6.2: Message center → repairs (#515) — port the upstream PR.

You are implementing work package **WP-6.2** of the PyLoxone remediation plan.
...
### WP-6.2 Message center → repairs (#515) — port the upstream PR.
- **Scope**: Message center → repairs (#515) — port the upstream PR.
