# Agent prompt — WP-6.3: `IntercomV2` (#466) — extend `switch.py:48`.

You are implementing work package **WP-6.3** of the PyLoxone remediation plan.
...
### WP-6.3 `IntercomV2` (#466) — extend `switch.py:48`.
- **Scope**: `IntercomV2` (#466) — extend `switch.py:48`.
