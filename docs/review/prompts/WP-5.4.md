# Agent prompt — WP-5.4: Documentation

You are implementing work package **WP-5.4** of the PyLoxone remediation plan.
...
- Phase: Phase 5
- Prerequisite packages that must be merged first: WP-3.4
- After Phase 3 (options and services are final by then).
