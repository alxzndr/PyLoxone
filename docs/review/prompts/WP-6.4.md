# Agent prompt — WP-6.4: `InfoOnlyDigital` device-class inference from `details.text` and category (#402).

You are implementing work package **WP-6.4** of the PyLoxone remediation plan.
...
### WP-6.4 `InfoOnlyDigital` device-class inference from `details.text` and category (#402).
- **Scope**: `InfoOnlyDigital` device-class inference from `details.text` and category (#402).
