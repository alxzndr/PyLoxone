# Agent prompt — WP-1.2: Remove `eval()` from the light platform

You are implementing work package **WP-1.2** of the PyLoxone remediation plan.
...
- Parallel-safe with WP-1.1, WP-1.3, WP-1.4.
