# Agent prompt — WP-1.5: Transient 401 during setup must retry, not die (incident 2026-09-02)

You are implementing work package **WP-1.5** of the PyLoxone remediation plan.
...
- Parallel-safe with the other WP-1.x packages; touches a different region of __init__.py than WP-1.1, so rebase rather than merge blindly.
