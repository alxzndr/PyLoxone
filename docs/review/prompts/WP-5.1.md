# Agent prompt — WP-5.1: `has_entity_name` and translation keys

You are implementing work package **WP-5.1** of the PyLoxone remediation plan.
...
- Phase: Phase 5
- Prerequisite packages that must be merged first: WP-3.4, WP-4.5
