# Agent prompt — WP-6.7: AudioZoneV2 sources/favourites/metadata/mute/on-off.

You are implementing work package **WP-6.7** of the PyLoxone remediation plan.
...
- **Scope**: AudioZoneV2 sources/favourites/metadata/mute/on-off.
