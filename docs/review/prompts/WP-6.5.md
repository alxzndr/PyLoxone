# Agent prompt — WP-6.5: Meter family: `EnergyManager`, `EnergyManager2`, `PowerUnit`, `Wallbox` — generalise the Meter sub-state loop.

You are implementing work package **WP-6.5** of the PyLoxone remediation plan.
...
### WP-6.5 Meter family: `EnergyManager`, `EnergyManager2`, `PowerUnit`, `Wallbox` — generalise the Meter sub-state loop.
- **Scope**: Meter family: `EnergyManager`, `EnergyManager2`, `PowerUnit`, `Wallbox` — generalise the Meter sub-state loop.
